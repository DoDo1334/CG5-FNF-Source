...
class PlayState extends MusicBeatState
{
	...
	override public function create()
		{
			...
			if (SONG == null)
				SONG = Song.loadFromJson('tutorial-remix');
			...
			else
			{
				...
				defaultCamZoom = 0.9;
				curStage = 'stage';
				bg = new FlxSprite(-446,-154).loadGraphic('assets/images/mixroom.png');
				...
				plush = new FlxSprite(1170, 370).loadGraphic("assets/images/ploosh.png");
	
				stageFront = new FlxSprite(-260, -4).loadGraphic('assets/images/recordroom.png');
				...
				stageCurtains = new FlxSprite(-260, -4).loadGraphic('assets/images/room lights.png');
	...
	private function generateSong(dataPath:String):Void
	{
		...
		for (section in noteData)
		{
			...
			for (songNotes in section.sectionNotes)
			{
				...
				var animateBoyfriend:Bool = false;
				var animationToUse:String = "";
				try
				{
					overrideAnimation = songNotes[3];
					animateBoyfriend = songNotes[4];
					animationToUse = songNotes[5];
				}
				catch(e)
				{
				...
				{
					swagNote = new Note(daStrumTime, daNoteData, oldNote, null, overrideAnimation, animateBoyfriend, animationToUse);
					swagNote.alpha = 0;
				}
				else
				{
	...
	override public function update(elapsed:Float)
	{
		...
		if (generatedMusic && PlayState.SONG.notes[Std.int(curStep / 16)] != null)
		{
			...
			{
				camFollow.setPosition(boyfriend.getMidpoint().x - 250, boyfriend.getMidpoint().y - 180);
	...
	private function keyShit():Void
	{
		...
		if ((upP || rightP || downP || leftP) && !boyfriend.stunned && generatedMusic)
		{
			...
			notes.forEachAlive(function(daNote:Note)
			{
				if (daNote.canBeHit && daNote.mustPress && !daNote.tooLate && !daNote.overridesAnimation)
				{
